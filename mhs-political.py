...
reddit_data_collection = db['politics_data']

toxicity_score_collection_name = 'toxicity_score_politics'
toxicity_score_collection = db[toxicity_score_collection_name]
error_collection_name = 'error_toxicity_score_politics'
    ...
    for document in reddit_data_collection.find():
        ...
        for comment in comments:
            ...
            if api_response:
                ...
                # Ensure uniqueness based on 'comment_text'
                ...
                # Store the error in the error collection
                error_entry = {
                    "comment_text": comment_text,
                    "timestamp": datetime.fromtimestamp(time.time()).strftime('%Y-%m-%d %H:%M:%S'),
